...
public class ConfiguratorSuccsessTests
{
        ...
        WiFiAdapter wifiAdapter)
    {
        ...
        Assert.DoesNotContain(status.Messages, m => m.MessageType == StatusType.WithWarnings || m.MessageType == StatusType.WithErrors);
    }
}